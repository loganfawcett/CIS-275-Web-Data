...
namespace Lab_10.Controllers
{
    public class GamesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "GameID,Title,PublisherID,Price")] Game game)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "GameID,Title,PublisherID,Price")] Game game)
        {
            if (ModelState.IsValid)
            {
